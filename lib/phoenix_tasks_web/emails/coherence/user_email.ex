...
defmodule PhoenixTasksWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: PhoenixTasksWeb.Coherence.EmailView, layout: {PhoenixTasksWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
